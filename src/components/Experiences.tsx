      ...
      <div className="flex flex-col text-center px-5 w-3/4">
        ...
        <div className="grid gap-10 mt-10 md:grid-cols-3 md:p-5 md:mt-10 md:place-content-between md:gap-8">
          <div className="flex flex-col items-center text-center border-2 hover:bg-slate-300 transition duration-300 ease-in-out hover:scale-108 border-black px-4 py-8 rounded-3xl flex-grow">
            ...
            <a href="bangkitcohort.png" className="mt-auto transition duration-300 ease-in-out hover:scale-110 hover:underline bg-black text-white px-6 py-2 rounded-full">Learn More</a>
          </div>
          <div className="flex flex-col items-center text-center border-2 hover:bg-slate-300 transition duration-300 ease-in-out hover:scale-108 border-black px-4 py-8 rounded-3xl flex-grow">
            ...
            <a href="https://github.com/AbrahamWillemH/Praktikum-SDA-2024" className="mt-auto transition duration-300 ease-in-out hover:scale-110 hover:underline bg-black text-white px-6 py-2 rounded-full">Learn More</a>
          </div>
          <div className="flex flex-col items-center text-center border-2 hover:bg-slate-300 transition duration-300 ease-in-out hover:scale-108 border-black px-4 py-8 rounded-3xl flex-grow">
        ...
        <div className="grid gap-10 mt-10 md:grid-cols-2 md:p-5 md:mt-10 md:place-content-between md:gap-8">
          <div className="flex flex-col items-center text-center border-2 hover:bg-slate-300 transition duration-300 ease-in-out hover:scale-108 border-black px-4 py-8 rounded-3xl flex-grow">
            ...
            <a href="https://www.instagram.com/p/C68kYbISRwZ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" className="mt-auto transition duration-300 ease-in-out hover:scale-110 hover:underline bg-black text-white px-6 py-2 rounded-full">Learn More</a>
          </div>
          <div className="flex flex-col items-center text-center border-2 hover:bg-slate-300 transition duration-300 ease-in-out hover:scale-108 border-black px-4 py-8 rounded-3xl flex-grow">
            ...
            <a href="https://www.instagram.com/p/CJlSUYHh7Ew/" className="mt-auto transition duration-300 ease-in-out hover:scale-110 hover:underline bg-black text-white px-6 py-2 rounded-full">Learn More</a>
          </div>
        </div>
      </div>
    </section>
