export default function Experiences() {
  return (
    <section id="about" className="flex flex-col min-h-screen items-center justify-center">
      <div className="flex flex-col text-center px-5 w-3/4">
        <h2 className="text-6xl font-semibold">Abraham Willem Hersubagyo</h2>
        <p className="mt-6">a passionate developer with experience in building web applications and other IT roles.</p>
        <div className="grid grid-cols-7 p-5 mt-10 place-content-between">
          <div className="flex flex-col items-center text-center">
            <img src="/public/website.gif" alt="website gif" className="w-10"/>
          ...
          <div className="flex flex-col items-center text-center">
            <img src="/public/ml.gif" alt="website gif" className="w-10"/>
          ...
          <div className="flex flex-col items-center text-center">
            <img src="/public/data.gif" alt="website gif" className="w-10"/>
          ...
          <div className="flex flex-col items-center text-center">
            <img src="/public/computer.gif" alt="website gif" className="w-10"/>
