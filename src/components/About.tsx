...
export default function About() {
    return (
      <motion.section transition={{duration: 1}} initial={{opacity:0, y:50}} whileInView={{opacity: 1, y:0}} id="about" className="flex flex-col min-h-180 items-center justify-center">
